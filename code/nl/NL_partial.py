...
B_COST_DRIVE	 = Beta('B_SP_COST_DRIVE',0,-10,10,0)
B_WALKTIME_DRIVE	 = Beta('B_SP_WALKTIME_DRIVE',0,-10,10,0)
B_IVT_DRIVE	 = Beta('B_SP_IVT_DRIVE',0,-10,10,0)

B_COST_BUS	 = Beta('B_RP_COST_BUS',0,-10,10,0)
B_WALKTIME_BUS	 = Beta('B_RP_WALKTIME_BUS',0,-10,10,0)
B_IVT_BUS	 = Beta('B_RP_IVT_BUS',0,-10,10,0)
B_WAITTIME_BUS = Beta('B_RP_WAITTIME_BUS', 0, -10, 10, 0)

B_COST_RS	 = Beta('B_SP_COST_RS',0,-10,10,0)
B_IVT_RS	 = Beta('B_SP_IVT_RS',0,-10,10,0)
B_WAITTIME_RS = Beta('B_SP_WAITTIME_RS', 0, -10, 10, 0)

B_WALKTIME_WALK	 = Beta('B_SP_WALKTIME_WALK',0,-10,10,0)
...
DRIVE_RP = ASC_RP_DRIVE + B_RP_AGE_DRIVE * age + B_RP_INC_DRIVE * inc + B_RP_EDU_DRIVE * edu \
        ...
        + B_COST_DRIVE * drive_cost + B_WALKTIME_DRIVE * drive_walktime \
        + B_IVT_DRIVE * drive_ivt
...
BUS_RP = ASC_RP_BUS + B_RP_AGE_BUS * age + B_RP_INC_BUS * inc + B_RP_EDU_BUS * edu \
        ...
        + B_COST_BUS * bus_cost + B_WALKTIME_BUS * bus_walktime \
        + B_IVT_BUS * bus_ivt + B_WAITTIME_BUS * bus_waittime
...
RS_RP = ASC_RP_RS + B_RP_AGE_RS * age + B_RP_INC_RS * inc + B_RP_EDU_RS * edu \
        ...
        + B_COST_RS * ridesharing_cost + B_IVT_RS * ridesharing_ivt \
        + B_WAITTIME_RS * ridesharing_waittime
...
biogeme.modelName = "NL_PARTIAL_RES"
...
print(pandasResults)
pandasResults.to_csv("nl_partial_coefs.csv")
...
data.to_csv("data_nl_partial_res.csv", index=False)
...
data_test.to_csv("data_nl_partial_test.csv", index=False)
