...
data_rp["rp"] = 1
data_sp["rp"] = 0
choice_rp = data["Y_train_rp"] + 1
choice_sp = data["Y_train_sp"] + 1
...
data_test_rp["rp"] = 1
data_test_sp["rp"] = 0
choice_test_rp = data["Y_test_rp"] + 1
choice_test_sp = data["Y_test_sp"] + 1
...
print(pandasResults)
pandasResults.to_csv("mnl_coefs.csv")
...
data.to_csv("data_mnl.csv", index=False)
...
data_test.to_csv("data_mnl_test.csv", index=False)
